...
import { BaseChartComponent } from '../../src/common/base-chart.component';

@Component({
  selector: 'ngx-charts-bar-horizontal-stacked-percent',
  template: `
    <ngx-charts-chart
      [view]="[width, height]"
      [showLegend]="legend"
      ...
      <svg:g [attr.transform]="transform" class="bar-chart chart">
        ...
        <svg:g ngx-charts-x-axis-strong-zero-tick
          *ngIf="xAxis"
          [xScale]="xScale"
          [dims]="dims"
          [showGridLines]="showGridLines"
        ...
        <svg:g
          *ngFor="let group of results; let index = index; trackBy:trackBy"
          ...
          <svg:g ngx-charts-series-horizontal-percent
            type="stacked"
            [xScale]="xScale"
            [yScale]="yScale"
            [colors]="colors"
...
export class BarHorizontalStackedPercentComponent extends BaseChartComponent {
